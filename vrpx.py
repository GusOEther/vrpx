...
def load():
    ...
    # if Yahoo recovers with one extra row the choice flips silently and two runs measure
    # different series — a reproducibility bug that looks like a finding. Credit quantconnect-47.
    MIN_ROWS = 1000
